 ...
 *
 * 【提案環境（PROP）専用】
 * このファイルは提案環境専用です。本番環境のIDは使用しません。
 */
...
/**
 * 提案環境の固定ID
 * ※本番環境のデータには一切アクセスしません
 */
const PROPOSAL_IDS = {
  SPREADSHEET_ID: '1k2utJ6uoQg2rRDPBgtdxBnkdzGD3ByAq34oyGqbPuYg',
  SCRIPT_ID: '1l-NZT9RZrCxlwDa2NT9Op7rxHvLAgZYmqUVvYB_TEZEKBx-A2JKl1lWw',
  FOLDER_ID: '1kDfjsZt6k6iXPRC6QRbjM6Kyfz2I1Bm5'
};

/**
 * 互換性のためのエイリアス（既存コードが動作するように）
 * ※提案環境のIDを返すので本番データにはアクセスしない
 */
const PRODUCTION_IDS = {
  SPREADSHEET_ID: PROPOSAL_IDS.SPREADSHEET_ID,
  ARCHIVE_BOOK_ID: PROPOSAL_IDS.SPREADSHEET_ID,  // アーカイブも同じシートを使用
  DEV_FOLDER_ID: PROPOSAL_IDS.FOLDER_ID
};
 ...
 */
const DEPLOY_IDS = {
  PRODUCTION: 'AKfycbyXhSH6vfkTvZvBY9N-69_GQzzv8vXJ8cY4nNgx-dI465y6a6swQkJsvLALNXBe8Gwttg',
  TEST: ''  // @HEAD
};
